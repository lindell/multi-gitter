...
func configurePlatform(cmd *cobra.Command) {
	...
	flags.StringSliceP("repo", "R", nil, "The name, including owner of a GitHub repository in the format \"ownerName/repoName\". If using Azure Devops, this should be the name of the project(s) containing the repos to modify. If using Azure DevOps, this should be in the format \"my-project/my-repo\".")
