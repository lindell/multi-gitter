...
get_binaries() {
  case "$PLATFORM" in
    ...
    linux/arm64) BINARIES="multi-gitter" ;;
    linux/armv6) BINARIES="multi-gitter" ;;
    windows/386) BINARIES="multi-gitter" ;;
    windows/amd64) BINARIES="multi-gitter" ;;
    windows/arm64) BINARIES="multi-gitter" ;;
    windows/armv6) BINARIES="multi-gitter" ;;
    *)
